...
$id=$_GET["id"];
$res=mysqli_query($conn,"select * from slots where slot_id=$id");
while($row=mysqli_fetch_array($res))
{
	$doc_id=$row["doc_id"];
	$slot_id=$row["slot_id"];
	$avaliabilty=$row["avaliabilty"];
	$time=$row["time"];
}
?>
<!DOCTYPE html>
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i>Edit Slot Details</div>
            <div id="content">
       			<div id="rightnow">
				<div class="block">
...
if(isset($_POST["submit1"])){
		mysqli_query($conn,"update slots set avaliabilty='$_POST[avaliabilty]',time='$_POST[time]' where slot_id=$id");	
	}
?>
