    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i> Add Doctor</div>
            <div id="content">
       			<div id="rightnow">
				<div class="block">
					...
					<table class="table table-bordered table-hover table-striped" style="table-layout: fixed">
						...
						<td><input type="text" class="form-control" name="ddegree"></td>
						</tr>
						<tr>
						<td>Doctor's Email</td>
						<td><input type="text" class="form-control" name="demail"></td>
						</tr>
						<tr>
						<td>Doctor's Password</td>
						<td><input type="text" class="form-control" name="dpass"></td>
						</tr>						
						<tr>
						<td>Doctor's Phone No.</td>
						<td><input type="text" class="form-control" name="dphn"></td>
						</tr>
						<tr>
						<td>Doctor's Address</td>
						<td><textarea class="form-control" name="dadd"></textarea></td>
						</tr>
						<tr>
						<td>Doctor's Time</td>
						<td>
						...
						<tr>
						<td colspan="2" align="center"><input type="submit" name="submit1" value="Add"></td>
						</tr>
					</table>
					</form>
<?php
if(isset($_POST["submit1"])){
	...
	mysqli_query($conn,"insert into doctor values ('$_POST[did]','$_POST[dname]','$dst1','$_POST[dtype]','$_POST[demail]','$_POST[dphn]','$_POST[ddegree]','$_POST[dtime]','$_POST[dadd])','','$_POST[dpass]')");
}
?>
	</div>
