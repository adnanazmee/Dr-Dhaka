    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i> Time Slot Details</div>
            <div id="content">
       			<div id="rightnow">
				<div class="block">
				<?php
				
				$res=mysqli_query($conn,"select * from slots");
				echo "<table class='table table-bordered table-hover table-striped' style='table-layout: fixed'>";
				echo "<tr>";
				echo "<th>"; echo "Doctor's ID"; echo "</th>";
				echo "<th>"; echo "Doctor's Availability"; echo "</th>";
				echo "<th>"; echo "Time Slot"; echo "</th>";
				...
				while($row=mysqli_fetch_array($res))
				{
					...
					echo "<td>"; echo $row["avaliabilty"]; echo "</td>";
					echo "<td>"; echo $row["time"]; echo "</td>";
					
					echo "<td>"; ?> <a href="delete_slot.php?id=<?php echo $row["slot_id"]; ?>"><button class="btn btn-danger">Delete</button></a> <?php echo "</td>";
					echo "<td>"; ?> <a href="edit_slot.php?id=<?php echo $row["slot_id"]; ?>"><button class="btn btn-success">Edit</button></a> <?php echo "</td>";
					echo "</tr>";
				}
				echo "</table>";
				?>
